            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    if($myid == NULL){
                        ...
                        print "<h4>You currently don't have any project</h4><br>";
                    }
                    else{
                        print "<h4>You are currently have the following project(s):</h4>";
                        print '<form role="form" onsubmit= "" method="POST" action="handlemodifyproject.php" id="myform">
                            <fieldset>';
                        //print "Members:<br>";
                        ...
                        <div class="panel-body">
                           ...
                           // print "<br>";
                                ...
                                foreach($row as $elm4){
                                 ...
                                 //print "<tr><td><input type='hidden' name='gname' value=$cname>$cname</td> <td><input type='hidden' name='coursename' value=$course>$course</td><td><input type='hidden' name='projectname' value={{yourtitle$count}}>{{yourtitle$count}}</td><td><input type='hidden' name='projectdescription' value={{yourdescription$count}}>{{yourdescription$count}}</td></tr>";
                                 ...
                                 foreach($row5 as $elm8){
                                  ...
                                  print "<tr><td><input type='hidden' name='gname' value=$cname>$cname</td> <td><input type='hidden' name='coursename' value=$course>$course</td><td><input type='hidden' name='projectname' value={{yourtitle$count}}>$projname</td><td><input type='hidden' name='projectdescription' value={{yourdescription$count}}>$projdes</td></tr>";
                                  
                                  //angular
                                  print "<tr><td><input type='hidden' name='gname' value=$cname>Type to See</td> <td><input type='hidden' name='coursename' value=$course>Updated Info</td><td><input type='hidden' name='projectname' value={{yourtitle$count}}>{{yourtitle$count}}</td><td><input type='hidden' name='projectdescription' value={{yourdescription$count}}>{{yourdescription$count}}</td></tr>";
